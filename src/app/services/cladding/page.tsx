...
export default function CladdingPage() {
  ...
  const benefits = [
    { title: "ACP Cladding Works", desc: "Premium aluminum composite panel cladding solutions" },
    { title: "Facade Branding", desc: "Shopfront and facade branding with signage integration" },
    { title: "Architectural Finishes", desc: "Decorative architectural finishes for buildings" },
    { title: "Composite Panels", desc: "Aluminum and composite panel installation" }
  ];
        ...
        >
          <div className="hero-content">
            <motion.div className="hero-text" variants={fadeInUp}>
              <h1>Cladding & Facade</h1>
              <div className="subtitle">Solutions</div>
              <p>
                ACP cladding & architectural facade branding solutions that transform building exteriors with premium materials and professional installation.
              </p>
            </motion.div>
