...
export default function ExhibitionPage() {
  ...
  const benefits = [
    { title: "Exhibition Stands", desc: "Custom-designed stands and kiosks for trade shows and events" },
    { title: "Pop-up Systems", desc: "Portable and easy-to-setup display systems" },
    { title: "Roll-up Banners", desc: "Professional roll-up and X-banner solutions" },
    { title: "POS Displays", desc: "Point of sale and in-store display solutions" }
  ];
        ...
        >
          <div className="hero-content">
            <motion.div className="hero-text" variants={fadeInUp}>
              <h1>Exhibition, Display</h1>
              <div className="subtitle">& POS</div>
              <p>
                Exhibition stands, kiosks & point of sale displays designed to capture attention and drive engagement at events and retail locations.
              </p>
            </motion.div>
