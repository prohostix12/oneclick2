...
export default function SignagePage() {
  ...
  const benefits = [
    { title: "Indoor & Outdoor Signage", desc: "Complete signage solutions for all environments" },
    { title: "Illuminated Signs", desc: "LED and backlit signage for 24/7 visibility" },
    { title: "3D Letter Signs", desc: "Premium acrylic, metal, and LED letter signs" },
    { title: "Wayfinding Systems", desc: "Directional and safety signage solutions" }
  ];
