...
export default function BrandingPage() {
  ...
  const benefits = [
    { title: "Brand Rollout", desc: "Complete brand implementation across all touchpoints and locations" },
    { title: "Corporate Identity", desc: "Consistent visual identity systems for your organization" },
    { title: "Interior Branding", desc: "Transform your spaces with strategic brand experiences" },
    { title: "Brand Consistency", desc: "Maintain unified brand presence across multiple locations" }
  ];
        ...
        >
          <div className="hero-content">
            <motion.div className="hero-text" variants={fadeInUp}>
              <h1>Brand</h1>
              <div className="subtitle">Identity</div>
              <p>
                Shape a unique brand personality that stands out in competitive markets through refined visuals, strategic direction, and meaningful design experiences.
              </p>
            </motion.div>
